...
<body>
	...
	<div class="container-fulid" style="margin-top:20px">
			...
			<div class="col-md-10">
			<form name="checkForm" id="checkForm" action="${pageContext.request.contextPath }/permissionServlet?method=change&&username=${permission.username }" class="form-horizontal" method="post">
			       
			       	<div class="col-md-12" align="left">
			        	<h4>角色名称：${permission.username }</h4>
			        </div>
					...
					<div class="col-md-1"></div>
					<div class="col-md-6">
					<input class="form-control  btn btn-info"type="submit" value="确认" >
					</div>
					<div class="col-md-5"></div>
					<div class="col-md-1"></div>
					<div class="col-md-6">
					<c:if test="${param.status.equals('1')}">
					    <div class="alert alert-danger">角色修改成功</div>    			
					</c:if>
					<c:if test="${param.status.equals('2')}">
					    <div class="alert alert-danger">角色修改失败</div>    			
					</c:if>
					</div>
					<div class="col-md-5"></div>
			</form>
