...
<div style="position: absolute;top: 5px;right: 20px" ><font color="ffffff">欢迎您：&nbsp;${userbean.username }|<a target="mainAction" href="updateMima.jsp">修改密码</a>|<a target="_top" onclick="loginout()" href="login.jsp">退出</a></font></div>
</div>
</body>
</html>