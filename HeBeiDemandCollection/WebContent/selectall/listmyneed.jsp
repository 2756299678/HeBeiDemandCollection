...
<body>
	...
	<div class="container-fluid">
		...
		<form action="NeedServlet?method=listneed&suoshu=me" method="post">
			...
			<a href="${pageContext.request.contextPath}/NeedServlet?method=listneed&status=4"><button class="btnMy">显示全部</button></a>
		</div>
		<div class="row-fluid">
