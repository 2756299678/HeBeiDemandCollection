...
//	    	'isPass': isPass,
    ...
    function (data) {
        ...
        var content ="<tr align='center'><th width='5%'>序号</th><th width='35%'>技术需求名称</th><th>发布人</th><th>发布时间</th>";//"<th width='25%'>操作</th></tr>";
        //var json = eval("(" + data + ")");
       // $.each(needbeans, function (index, item) {
    	  ...
    	  for (var item in data) {
            ...
            content +=
                ...
                data[item].xQMC+ "</td>";
            content += "<td>" + data[item].name + "</td>";
            content += "<td>" + data[item].create_date + "</td>";
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" background="#B1D8EA" bgcolor="#B1D8EA" onload="getInfoData();">	
	<div id="show" style="background-color: #ffffff; position: relative; margin-top: 5px; margin-left: 10px; border: #ffffff 2px solid">
		<div style="position: relative; min-height: 490px;">
			<div style="background: #C0E4FA; position: relative;" align="center">欢迎来到河北省重大技术需求系统</div>
			<fieldset>
				<legend>
